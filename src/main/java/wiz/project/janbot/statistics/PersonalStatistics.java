...
public final class PersonalStatistics {
            ...
            for (final Object e : readResult.elements()) {
                ...
                if (!valueString.equals("-")) {
                    ...
                    case "calledMenTsuCount":
                        ...
                        else if (calledMenTsuCount == 2) {
                        	_twoCalledCount++;
                        }
                        else if (calledMenTsuCount == 3) {
                        	_threeCalledCount++;
                        }
                        else if (calledMenTsuCount == 4) {
                        	_fourCalledCount++;
                        }
                        _playCountWithCalledCount++;
                        break;
    ...
    public double calledRate() {
        ...
        if (_playCountWithCalledCount != 0) {
        	calledRate = (double) (_oneCalledCount + _twoCalledCount + _threeCalledCount + _fourCalledCount) * 100 / (double) _playCountWithCalledCount;
        }
        return calledRate;
    }
    ...
    public double fourCalledRate() {
        ...
        if (_playCountWithCalledCount != 0) {
        	fourCalledRate = (double) _fourCalledCount * 100 / (double) _playCountWithCalledCount;
        }
    ...
    public double oneCalledRate() {
        ...
        if (_playCountWithCalledCount != 0) {
        	oneCalledRate = (double) _oneCalledCount * 100 / (double) _playCountWithCalledCount;
        }
    ...
    public double threeCalledRate() {
        ...
        if (_playCountWithCalledCount != 0) {
        	threeCalledRate = (double) _threeCalledCount * 100 / (double) _playCountWithCalledCount;
        }
    ...
    public double twoCalledRate() {
        ...
        if (_playCountWithCalledCount != 0) {
        	twoCalledRate = (double) _twoCalledCount * 100 / (double) _playCountWithCalledCount;
        }
